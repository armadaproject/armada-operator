...
// LookoutV2 is the Schema for the lookoutV2 API
type LookoutV2 struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   LookoutV2Spec   `json:"spec,omitempty"`
	Status LookoutV2Status `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// LookoutV2List contains a list of LookoutV2
type LookoutV2List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LookoutV2 `json:"items"`
}

// LookoutV2Spec defines the desired state of LookoutV2
type LookoutV2Spec struct {
	...
	// ApplicationConfig is the internal LookoutV2 configuration which will be created as a Kubernetes Secret and mounted in the Kubernetes Deployment object
	...
	// Resources is the configuration block for setting LookoutV2 resource requirements
	Resources *corev1.ResourceRequirements `json:"resources,omitempty"`
	// Tolerations is the configuration block for specifying which taints can the LookoutV2 pod tolerate
	...
	// NodeSelector restricts the LookoutV2 pod to run on nodes matching the configured selectors
...
// LookoutV2Status defines the observed state of lookoutV2
type LookoutV2Status struct{}

func init() {
	SchemeBuilder.Register(&LookoutV2{}, &LookoutV2List{})
}
