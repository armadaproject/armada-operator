...
func (r *SchedulerIngester) ValidateCreate() error {
...
func (r *SchedulerIngester) ValidateUpdate(old runtime.Object) error {
...
func (r *SchedulerIngester) ValidateDelete() error {
