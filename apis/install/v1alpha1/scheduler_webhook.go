...
var schedulerlog = logf.Log.WithName("scheduler-resource")
...
func (r *Scheduler) Default() {
	schedulerlog.Info("default", "name", r.Name)

	// image
	if r.Spec.Image.Repository == "" {
		r.Spec.Image.Repository = "gresearchdev/armada-scheduler"
	}
