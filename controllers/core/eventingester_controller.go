...
//+kubebuilder:rbac:groups=core.armadaproject.io,resources=eventingesters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.armadaproject.io,resources=eventingesters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.armadaproject.io,resources=eventingesters/finalizers,verbs=update
...
func (r *EventingesterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&corev1alpha1.Eventingester{}).
		Complete(r)
}
